    ...
    this.innerHTML = `
      <style>
        ...
        ${TAG} .diff .bug::after {
          ...
          border-radius: 3px;
          opacity: 0;
          animation: tip03-fade 400ms var(--db-ease) 1700ms forwards;
        }
        ${TAG} .note {
          margin: var(--db-space-3) 0 0;
          font-size: var(--db-fs-small);
          line-height: var(--db-lh-small);
          color: var(--db-text-muted);
          text-align: center;
          opacity: 0;
          animation: tip03-fade 500ms var(--db-ease) 2000ms forwards;
        }
        ${TAG} .note code {
        ...
        ${TAG} .punch {
          ...
          text-align: center;
          opacity: 0;
          animation: tip03-fade 600ms var(--db-ease) 2300ms forwards;
        }
