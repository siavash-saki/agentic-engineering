  ...
  connectedCallback() {
    this.innerHTML = `
      <style>
        ...
        ${TAG} .qa:nth-child(1) { animation: tip05-pop 400ms var(--db-ease) 500ms forwards; }
        ${TAG} .qa:nth-child(2) { animation: tip05-pop 400ms var(--db-ease) 900ms forwards; }
        ${TAG} .qa:nth-child(3) { animation: tip05-pop 400ms var(--db-ease) 1300ms forwards; }
        ${TAG} .qa:nth-child(4) { animation: tip05-pop 400ms var(--db-ease) 1700ms forwards; }
        ...
        ${TAG} .spec li:nth-child(1) { animation: tip05-pop 400ms var(--db-ease) 800ms forwards; }
        ${TAG} .spec li:nth-child(2) { animation: tip05-pop 400ms var(--db-ease) 1200ms forwards; }
        ${TAG} .spec li:nth-child(3) { animation: tip05-pop 400ms var(--db-ease) 1600ms forwards; }
        ${TAG} .spec li:nth-child(4) { animation: tip05-pop 400ms var(--db-ease) 2000ms forwards; }
        ...
        ${TAG} .punch {
          ...
          text-align: center;
          opacity: 0;
          animation: tip05-fade 600ms var(--db-ease) 2300ms forwards;
        }
      ...
      <div class="wrap">
        ...
        <p class="lede">
          ...
          Drehen Sie die Richtung um: der Agent fragt, Sie antworten.
        </p>
        ...
        <p class="punch">
          Aus vier Fragen entsteht eine <b>Spec</b>. Aus Vermutungen entsteht Code.
        </p>
      </div>
    `;
  }
