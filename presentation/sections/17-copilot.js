...
const TAG = 's17-copilot';

const STEPS = [
  {
    when:  'Heute',
    time:  '15 Minuten',
    title: 'AGENTS.md anlegen',
    body:  'Schreibt im Repo-Root die Datei <code>AGENTS.md</code>. Drei Abschnitte reichen für den Anfang:',
    bullets: [
  ...
  },
  {
    ...
    body:  'Wählt eine wiederkehrende Aufgabe — Code-Review-Checkliste, Release-Schritte, Onboarding-Eckpunkte. Als Skill speichern:',
    bullets: [
  ...
  },
  {
    ...
    body:  'Lasst den Agenten mit eurem wichtigsten internen Tool reden — Jira, Confluence, einem internen API:',
    bullets: [
      'DB GenAI Hub als MCP-Server vorgesehen',
      'Config: <code>~/.copilot/mcp-config.json</code>',
      'Schreibt ihr einmal — alle vier CLIs nutzen ihn',
    ],
  },
];
