...
class SectionTip09Multi extends HTMLElement {
  connectedCallback() {
    this.innerHTML = `
      <style>
        ${TAG} {
      ...
      <div class="wrap">
        ...
        <h1>Claude fürs <b>Frontend</b>, GPT fürs <b>Backend</b> — und alles dazwischen</h1>
        <p class="lede">
          ...
          beim Start einer Aufgabe das richtige Werkzeug.
        </p>
...
customElements.define(TAG, SectionTip09Multi);
