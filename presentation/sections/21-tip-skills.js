    ...
    this.innerHTML = `
      <style>
        ...
        ${TAG} .expand {
          ...
          animation: tip04-unfold 500ms var(--db-ease) 1700ms forwards;
        }
        ...
        ${TAG} .expand li:nth-child(1) { animation: tip04-pop 400ms var(--db-ease) 1950ms forwards; }
        ${TAG} .expand li:nth-child(2) { animation: tip04-pop 400ms var(--db-ease) 2100ms forwards; }
        ${TAG} .expand li:nth-child(3) { animation: tip04-pop 400ms var(--db-ease) 2250ms forwards; }
        ${TAG} .expand li:nth-child(4) { animation: tip04-pop 400ms var(--db-ease) 2400ms forwards; }
        ...
        ${TAG} .punch {
          ...
          text-align: center;
          opacity: 0;
          animation: tip04-fade 600ms var(--db-ease) 2600ms forwards;
        }
